...
#Classe Repartition qui repartie les chansons dans différents genre
class Repartition:
...
#Class qui permet de récupérer les stopwords         
class stopword:
...
#Classe Fille de Repartition qui recupere le genre le plus populaire
...
#Classe Fille de Repartition qui recupere le moins le plus populaire     
